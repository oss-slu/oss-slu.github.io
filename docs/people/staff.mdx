...
<div className="lead-container">
  <div className="lead-image">
    <img src="/img/dennis_gilli.jpg" alt="Dennis Gilli" className="LeadImage"/>
  </div>
  <div className="lead-description">
    #### Dennis Gilli
    
    Dennis Gilli is a Systems Engineer on the Research Technology team; building reliable, scalable infrastructure and tooling for scientific computing. He collaborates closely with faculty, researchers, and IT teams as a technical expert in HPC, research storage, cloud, automation, and specialized software.
  </div>
</div>

<div className="lead-container">
  <div className="lead-image">
    <img src="/img/gage_dwiggins.jpg" alt="Gage Dwiggins" className="LeadImage"/>
  </div>
  <div className="lead-description">
    #### Gage Dwiggins
    
    Gage Dwiggins is a Research Technologist at SLU specializing in Linux systems, HPC, and enterprise networking and security. His work ranges from architecting multi-environment web server infrastructure for research teams to data center operations and all things in between — bridging the gap between enterprise IT and research.
  </div>
</div>

<div className="lead-container">
  <div className="lead-image">
    <img src="/img/vani_walvekar.jpg" alt="Vani Walvekar" className="LeadImage"/>
  </div>
  <div className="lead-description">
    #### Vani Walvekar

    Vani Walvekar is a Research Technologist at Saint Louis University's Research Technology Group, specializing in HPC infrastructure and workflow automation. She works closely with researchers to optimize scientific workflows on the Libra HPC cluster and contributes to open-source HPC projects.
  </div>
</div>
